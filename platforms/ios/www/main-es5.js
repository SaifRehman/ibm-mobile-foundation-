...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, renderer, alertController) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.renderer.listenGlobal('document', 'mfpjsloaded', function () {
            console.log('--> MobileFirst API plugin init complete');
            _this.MFPInitComplete();
        });
    };
    AppComponent.prototype.MFPInitComplete = function () {
    ...
    AppComponent.prototype.registerChallengeHandler = function () {
        var _this = this;
    ...
    AppComponent.prototype.displayLoginChallenge = function (response) {
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.UserLoginChallengeHandler.submitChallengeAnswer(data);
                                    }
                                }
                            ]
                        })];
...
module.exports = __webpack_require__(/*! /Users/saifurrehman/Desktop/POCs/cumulus-bank/MFPUserLogin/src/main.ts */"./src/main.ts");
